        ...
        @csrf
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input name="name" type="text" class="form-control" id="inputEmail3" placeholder="Tag Tile">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-3 col-form-label">Tag Slug</label>
              <div class="col-sm-9">
                <input name="slug" type="text" class="form-control" id="inputEmail3" placeholder="Tag Slug">
              </div>
            </div>
          </div>
          <!-- /.card-body -->
